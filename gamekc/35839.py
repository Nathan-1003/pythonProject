...
# 讀取 JavaScript 
with open('/Users/menglungtsai/pythonProject/gamekc/kcjs/35839_冠亚和两面_大.js', 'r') as f:
    js_code = f.read()
...
for i in range(500):
    ...
    if result == 1:
        ...
        count_minus_1 += 1
        print(f"組合 {i + 1}: {combo}, 冠亞總和{s},結果: {result}{Style.RESET_ALL}")

# 輸出統計結果
print(f"1 的組數: {count_1}")
print(f"-1 的組數: {count_minus_1}")
print(f"{Fore.RED} 冠亚和两面_小，冠亚總和大於等於12")
